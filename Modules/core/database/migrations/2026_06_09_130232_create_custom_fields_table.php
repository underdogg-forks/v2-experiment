...
return new class () extends Migration {
    public function up(): void
    {
        Schema::create('custom_fields', static function (Blueprint $table) {
            ...
            $table->string('custom_field_table', 50)->nullable()->index('custom_fields_table_index');
            ...
            $table->unique(['custom_field_table', 'custom_field_label'], 'custom_fields_table_label_unique');
